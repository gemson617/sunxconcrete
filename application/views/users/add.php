    ...
    <?php
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">Add Employee Management</h4>
        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-body">
                        <form action="<?php echo site_url('users/add'); ?>" method="post" class="needs-validation" novalidate>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="validationCustom02" class="form-label">First Name <span class="mandatory">*</span></label>
                                        <input type="text" name="first_name" class="form-control" id="validationCustom02" placeholder="Enter First Name" required>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="address" class="form-control" id="validationCustom02" placeholder="Enter Address">
                                        <div class="valid-feedback">
                                            Looks good!
                                        </div>
                                        <div class="invalid-feedback">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="aadhar_no" class="form-control" id="aadhar_no" placeholder="Enter Aadhar Card Number">
                                        <div class="valid-feedback">
                                            Looks good!
                                        </div>
                                        <div class="invalid-feedback">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="date" name="doj" class="form-control" id="doj" placeholder="Enter Date of Joining">
                                        <div class="valid-feedback">
                                            Looks good!
                                        </div>
                                        <div class="invalid-feedback">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="bank" class="form-control" id="bank" placeholder="Enter Bank Name">
                                        <div class="valid-feedback">
                                            Looks good!
                                        </div>
                                        <div class="invalid-feedback">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="account_no" class="form-control" id="account_no" placeholder="Enter Bank Account Number">
                                        <div class="valid-feedback">
                                            Looks good!
                                        </div>
                                        <div class="invalid-feedback">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="ifsc_no" class="form-control" id="ifsc_no" placeholder="Enter IFSC">
                                        <div class="valid-feedback">
                                            Looks good!
                                        </div>
                                        <div class="invalid-feedback">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="email" class="form-control" id="validationCustom02" placeholder="Enter Email" onchange="return validateEmail(event);" required>
                                        <div class="valid-feedback">
                                            Looks good!
                                        </div>
                                        <div class="invalid-feedback">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="mobile" class="form-control" id="mobile" onkeypress="return isNumberKey(event);" maxlength="10" placeholder="Enter Contact Number" required>
                                        <div class="valid-feedback">
                                            Looks good!
                                        </div>
                                        <div class="invalid-feedback">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="validationCustom02" class="form-label">Alternative Contact Number <span class="mandatory">*</span></label>
                                        <input type="text" name="contact_number" class="form-control" id="contact_number" onkeypress="return isNumberKey(event);" maxlength="10" placeholder="Enter Alternative Contact Number" required>
                                        <div class="valid-feedback">
                                            Looks good!
                                        </div>
                                        <div class="invalid-feedback">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="validationCustom02" class="form-label">Type</label><span class="mandatory">*</span>
                                        <select name="role_id" class="form-control" id="validationCustom02 role_id" required>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="control">
                                            <input class="form-control key w-100" id="password" type="password" name="password" placeholder="Password" required>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="control">
                                            <input class="form-control key w-100" id="confirm_password" type="password" name="confirm_password" placeholder="Confirm Password" required>
