...
<div class="wrapper fadeInDown">
  <div id="formContent">
    ...
    <div class="fadeIn first">
      <img src="https://krisgrc.com/assets/images/KRSI.png" id="icon" alt="User Icon" />
    </div>

    <!-- Login Form -->
    <form action="<?php echo site_url('verify_password/update_password');?>" method="post">
          ...
          <div class="pod">
            <h3>Create a password</h3>
              <fieldset class="fieldset-password">
                ...
                <input type="text" id="input-password" class="required form-control" autocomplete="off" name="login" placeholder="password">
