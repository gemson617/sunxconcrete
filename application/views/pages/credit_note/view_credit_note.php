                                ...
                                <?php foreach ($credit_note as $key => $cn) { 
                                    ...
                                    <td><?php echo $key + 1; ?></td>  
                                        ...
                                        <td>
                                            <table>
                                                <tr>
                                                    <td><a href="<?php echo site_url('Quotation/creditInvoice/' . $cn->id); ?>"><button type="button" class="btn btn-sm btn-info waves-effect waves-light"><i class="bx bx-file"></i></button></a></td>
