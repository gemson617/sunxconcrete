    ...
    <?php
        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-body">
                    <?php $direct =$this->auth_level =='9'? 'edit':'temp_edit';  ?> 
                        <form action="<?php echo site_url('users/'.$direct.'/'.$default['user_id']); ?>" method="post" class="needs-validation" novalidate>
                            <div class="row">
                            <div class="col-md-6">
                                    <div class="mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <label>Edit Remarks</label><span class="mandatory">*</span>
                                    <textarea type="text" name="edit_remark" class="form-control" id="edit_remark" placeholder="Enter Remarks" required> </textarea>
                                        <!-- <input name="edit_remark" id="edit_remark" type="text" class="form-control edit_remark"
                                            placeholder="Remarks"> -->
                                        <?php if (form_error('edit_remark')) {?>
                                        <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                                <span aria-hidden="true">×</span>
                                            </button>
                                            <?php echo form_error('edit_remark'); ?>
                                        </div>
                                        <?php }?>
                                    </div>
                                </div>
