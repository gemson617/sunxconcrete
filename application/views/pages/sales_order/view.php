                                ...
                                <?php foreach ($salesOrder as $key => $sales) { ?>
                                    <tr>
                                        ...
                                        <td>                                            
                                            ...
                                            <button type="button" class="btn btn-sm btn-success waves-effect waves-light  delete-category" data-toggle="modal"  data-id="<?= $sales->id ?>" data-target="#myModal">Sale </button>
            ...
            <div class="modal-body">
                <form id="myForm" method="POST" action="<?php echo site_url('SalesOrder/getQuantity/'.$sales->id); ?>">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Enter the Sales Order Quantity" id="qty" name="qty">
                    </div>
