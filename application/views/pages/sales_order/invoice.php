                ...
                <div class="card-body">
                    ...
                    <tbody style="border: 1px solid #ccc;">
                            ...
                            <tr style="border: 1px solid #ccc;" >
                                ...
                                <td style="border: 1px solid #ccc;padding:5px;text-align:left;"><?= $salesOrder['total_quantity'] ?></td>
                    ...
                    <tr style="border: 1px solid #ccc;">
                            ...
                            <td style="border: 1px solid #ccc;padding-left:50px; ">₹ <?= $salesOrder['sub_total'] ?></td>
                        </tr>

                        <!-- <tr style="border: 1px solid #ccc;">
                            <td style="border: 1px solid #ccc; padding-right:30px;" colspan="4" align="right">Amount</td>
                            <td style="border: 1px solid #ccc;padding-left:50px; ">₹ <?= $salesOrder['amount'] ?></td>
                        </tr> -->
                        <tr style="border: 1px solid #ccc; ">
                            <td  style="border: 1px solid #ccc;padding-right:30px; " colspan="4" align="right">SGST (9%)</td>
                            <td style="border: 1px solid #ccc;padding-left:50px;">₹ <?= $salesOrder['sgst'] ?></td>
                        </tr>
                        <tr style="border: 1px solid #ccc;">
                            <td style="border: 1px solid #ccc; padding-right:30px;" colspan="4" align="right">CGST (9%)</td>
                            <td style="border: 1px solid #ccc;padding-left:50px;">₹ <?= $salesOrder['cgst'] ?></td>
                        </tr>
                        <tr style="border: 1px solid #ccc;">
                            <td style="border: 1px solid #ccc; padding-right:30px;" colspan="4" align="right">IGST (18%)</td>
                            <td style="border: 1px solid #ccc;padding-left:50px;">₹ <?= number_format($salesOrder['cgst'] + $salesOrder['sgst'],2) ?></td>
                        </tr>
                        <tr style="border: 1px solid #ccc;">
...
// Example usage:
const number = <?=  $salesOrder['grand_total']  ?>;
