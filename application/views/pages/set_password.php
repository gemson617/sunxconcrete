...
<head>
    ...
    <meta charset="utf-8" />
    <title>Set Password | Expat</title>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="p-2 mt-1">
                                ...
                                <!--NEW PASS-->
                                <form action="<?php echo site_url('auth/set_new_password1'); ?>" method="post">
                                    <!--PASSWORD VALIDATION-->
                                    <div id="page">
                                        <div class="row">
                                            <div class="col-lg-12 col-lg-offset-4">
                                                <div class="pod">
                                                    ...
                                                    <div class="col-md-12 clearfix">
                                                        <input type="submit" class="fadeIn fourth mybtn" value="Choose Your Password" disabled>
                                                    </div>
