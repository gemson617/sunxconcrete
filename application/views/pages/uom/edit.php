    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-6">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">Edit UOM</h4>                    
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-body">
                        <form action="<?php echo site_url('Uom/edit/' . $default['uom_id']); ?>" method="post" class="needs-validation" enctype="multipart/form-data" novalidate>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="validationCustom01" class="form-label"> UOM</label>
                                        <input type="text" name="uom" class="form-control" id="uom" placeholder="Enter UOM Name" value="<?php echo $default['uom']; ?>" required>
