                                ...
                                <div class="col-md-3">                                 
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control" name="sold_to" id="sold_to" >
                                         ...
                                         <option value="<?php echo $customer->CusID.'|'.$customer->CusAdId;; ?>" data-info="<?= $customer->customer_state ?>" <?= ($quotation['sold_to_party'] == $customer->CusID.'|'.$customer->CusAdId) ? 'selected' : '' ?>><?php echo $customer->company_name.'-'.$customer->customer_address_1.','.$customer->customer_address_2.','.$customer->customer_city; ?>
                                         <?php }?>
                                        </select>                                          
                                        <div class="valid-feedback">
                                            Looks good!
                                ...
                                <div class="col-md-3">                                 
                                 <div class="mb-3">
                                     ...
                                     <select class="form-control" name="ship_to" id="ship_to" required>
                                         <option value="">--Select Customer --</option>
                                         <?php foreach($customers as $customer) {?>
                                         <option value="<?php echo $customer->CusID.'|'.$customer->CusAdId;; ?>" <?= ($quotation['ship_to_party'] == $customer->CusID.'|'.$customer->CusAdId) ? 'selected' : '' ?>><?php echo $customer->company_name.'-'.$customer->customer_address_1.','.$customer->customer_address_2.','.$customer->customer_city; ?>
                                         <?php }?>
                                     </select>                                         
                                      <div class="valid-feedback">
                                         Looks good!
